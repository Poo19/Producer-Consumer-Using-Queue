...
/*----------------------------- */
/*In this Assignment pthread library to write a C program that creates a number of producer and consumer threads.
The producer threads will generate random numbers to be stored in a circular queue. The consumer threads will remove elements from the queue. */
/*producer and consumer concept can be implemented using the circular queue using datta structures */
